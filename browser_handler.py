...
class BrowserHandler:
    ...
    def _create_browser_profile(self):
        ...
        profile.set_preference("browser.download.dir", self.args.download_folder)
        profile.set_preference("browser.helperApps.neverAsk.saveToDisk", "application/epub+zip, application/pdf")
